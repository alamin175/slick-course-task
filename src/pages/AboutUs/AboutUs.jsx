...
const AboutUs = () => {
	return (
		<div className="bg-secondaryColor pt-20 relative -top-20 rounded-[50px]">
			<h1 className="text-center text-7xl font-extrabold text-white uppercase leading-tight">
			...
			<div className="flex justify-between mt-8 ">
				...
				<img className="mb-24 mx-auto" src={img2} alt="" />
			...
			<div className="mx-auto relative bottom-48 flex w-3/5">
				<p className="text-center bg-white p-12 absolute bg-opacity-10 backdrop-blur-3xl border-[1px] border-gray-400 text-white rounded-[35px] uppercase tracking-widest">
